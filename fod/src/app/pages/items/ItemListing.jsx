  ...
  return (
    <PageWrapper>
      ...
      <PageHead>
        ...
        />
        <HeadActions>
          <InputSearch width="260px" onSearch={handleSearch} placeholder="Search by name or code..." />
          <AddButton
            type="primary"
            icon={<PlusOutlined />}
        ...
        {loading ? (
          <SkeletonGrid>
            {Array.from({ length: 8 }).map((_, i) => (
              <SkeletonCard key={i}>
                <Skeleton.Image active style={{ width: "100%", height: 180, borderRadius: 14 }} />
          ...
          <EmptyState>
            ...
            <EmptyDesc>
              Your catalog is empty. Start adding products to manage your inventory.
            </EmptyDesc>
            <AddButton
              type="primary"
              icon={<PlusOutlined />}
