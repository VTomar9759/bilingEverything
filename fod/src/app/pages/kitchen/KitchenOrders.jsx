                ...
                <KotFooter>
                  {kot.status === "Pending" ? (
                    <Button 
                      ...
                      style={{ height: 38, fontWeight: 700, borderRadius: 8 }}
                    >
                      Start Cooking
                    </Button>
                  ) : (
...
const EmptyCard = styled(Card)`
  ...
  h3 { font-family: var(--font-display); font-size: 16px; font-weight: 700; color: var(--color-text-primary); margin: 0 0 4px; }
