    ...
    <Form form={form} layout="vertical" onFinish={onSave}>
      ...
      <SectionCard>
        ...
        <TwoCol>
          ...
          >
            <Input placeholder="e.g. Delight Cafe" style={{ height: 38, borderRadius: 8 }} />
          </Form.Item>
          <Form.Item
            name="currency"
          ...
          >
            <Select placeholder="Select currency" style={{ height: 38 }}>
      ...
      <Button
        ...
        icon={<SaveOutlined />}
        loading={loading}
        style={{ height: 40, fontWeight: 600, borderRadius: 8, marginTop: 4 }}
      >
        Save Settings
      </Button>
    </Form>
